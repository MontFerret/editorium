...
func acquireFerretd(ctx context.Context, root string, target vscodeTarget, client httpDoer) (acquiredFerretd, error) {
	if client == nil {
...
func extractBinary(path string, target vscodeTarget) ([]byte, error) {
