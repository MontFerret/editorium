...
untouched. Git enforces LF line endings for schema inputs and generated Java
sources on every platform so byte-for-byte protocol checks are independent of
checkout settings. Schema comments retain their line endings in generated Java,
so both inputs and outputs require LF.
